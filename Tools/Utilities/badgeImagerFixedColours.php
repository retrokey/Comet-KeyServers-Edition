...
function getColour($colcode)
{
    if ("$colcode" == "01") {
        ...
        $col = hexStr(221) . hexStr(168) . hexStr(255);
    } else if($colcode == '22') {
        $col = hexStr(255) . hexStr(180) . hexStr(121);
    } else if($colcode == '23') {
        $col = hexStr(194) . hexStr(169) . hexStr(110);
    } else if($colcode == '24') {
        $col = hexStr(122) . hexStr(122) . hexStr(122);
    }
